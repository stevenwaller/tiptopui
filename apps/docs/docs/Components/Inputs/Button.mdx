...
When just using icons, you can set the `fixedRatio` prop to make sure the button is always a square.
...
<div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
  ...
  <Button shape="pill" variant="success" fixedRatio>
    <IconCheck size={14} />
  </Button>
  <Button shape="circle" variant="danger" fixedRatio>
