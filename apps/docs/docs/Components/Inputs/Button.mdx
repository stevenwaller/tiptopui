...
```jsx live
<div>
  <Button fullWidth mb="3" justify="start">start</Button>
  <Button fullWidth mb="3" justify="center">center</Button>
  <Button fullWidth mb="3" justify="end">end</Button>
  <Button fullWidth mb="3" justify="space-between" slotStart="😀" slotEnd="😠">space-between</Button>
  <Button fullWidth mb="3" justify="space-around" slotStart="😀" slotEnd="😠">space-around</Button>
</div>
